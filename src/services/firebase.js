...
export async function getUserIdByUsername(username) {
  const result = firebase.firestore().collection('users').where;
}
...
export async function isUserFollowingProfile(logedInUserUsername, profileUserId) {
  const result = await firebase
    .firestore()
    .collection('users')
    .where('username', '==', logedInUserUsername)
